...
export const GRAPH_SPEC = Object.freeze({
  ...
  'bcsp-domain': {
    ...
    external: [['jiff', NORMAL], ['proptest', DEV], ['thiserror', NORMAL], ['time', NORMAL]],
  },
  'bcsp-query': {
    dir: 'crates/bcsp-query',
    kind: 'lib',
    internal: ['bcsp-contracts'],
    external: [['proptest', DEV], ['thiserror', NORMAL], ['time', NORMAL], ['tracing', NORMAL]],
  },
  'bcsp-rutgers-client': {
    dir: 'crates/bcsp-rutgers-client',
    kind: 'lib',
    internal: ['bcsp-contracts'],
    external: [['reqwest', NORMAL], ['serde', NORMAL], ['serde_json', NORMAL], ['sha2', NORMAL], ['thiserror', NORMAL], ['tokio', NORMAL]],
  },
  'bcsp-operational-storage': {
    dir: 'crates/bcsp-operational-storage',
    kind: 'lib',
    internal: ['bcsp-contracts'],
    external: [['rusqlite', NORMAL, ['bundled', 'cache']], ['rusqlite', DEV, ['bundled', 'hooks']], ['serde', NORMAL], ['serde_json', NORMAL], ['sha2', NORMAL], ['tempfile', DEV], ['thiserror', NORMAL], ['time', NORMAL]],
  },
  'bcsp-catalog': {
    dir: 'crates/bcsp-catalog',
    kind: 'lib',
    internal: ['bcsp-contracts', 'bcsp-operational-storage', 'bcsp-rutgers-client'],
    external: [['serde', NORMAL], ['serde_json', NORMAL], ['tempfile', DEV], ['thiserror', NORMAL], ['time', NORMAL], ['tracing', NORMAL]],
  },
  'bcsp-open': {
    dir: 'crates/bcsp-open',
    kind: 'lib',
    internal: ['bcsp-contracts', 'bcsp-operational-storage', 'bcsp-rutgers-client'],
    external: [['jiff', NORMAL], ['proptest', DEV], ['thiserror', NORMAL], ['time', NORMAL], ['tokio', NORMAL], ['tracing', NORMAL]],
  },
  'bcsp-watch': {
    dir: 'crates/bcsp-watch',
    kind: 'lib',
    internal: ['bcsp-contracts'],
    external: [['proptest', DEV], ['thiserror', NORMAL], ['time', NORMAL]],
  },
  'bcsp-application': {
    ...
    external: [['axum', NORMAL], ['rusqlite', NORMAL], ['serde', NORMAL], ['serde_json', NORMAL], ['sha2', DEV], ['tempfile', DEV], ['thiserror', NORMAL], ['time', NORMAL], ['tokio', NORMAL], ['tower', NORMAL], ['tracing', NORMAL], ['tracing-subscriber', DEV]],
  },
  'bcsp-local-user-state': {
    ...
    external: [['rusqlite', NORMAL], ['serde', NORMAL], ['serde_json', NORMAL], ['sha2', NORMAL], ['tempfile', DEV], ['thiserror', NORMAL]],
  },
  'bcsp-local-runtime': {
  ...
  'bcsp-public-operations': {
    ...
    external: [['rusqlite', DEV], ['tempfile', DEV], ['thiserror', NORMAL]],
  },
  'bcsp-public-runtime': {
    dir: 'crates/bcsp-public-runtime',
    kind: 'lib',
    internal: ['bcsp-application', 'bcsp-contracts', 'bcsp-domain', 'bcsp-open', 'bcsp-operational-storage', 'bcsp-public-operations', 'bcsp-watch'],
