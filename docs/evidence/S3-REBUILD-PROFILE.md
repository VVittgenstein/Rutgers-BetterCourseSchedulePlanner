...
- A4-1 unsatisfied: campuses: NB(pc-2ff7575c4c21) only; NK missing; CM missing
...
|---|---|---|---|
| A4-1 | Multi-target evidence: at least NB, NK, CM independently evaluable from independent data provenance | no | campuses: NB(pc-2ff7575c4c21) only; NK missing; CM missing |
