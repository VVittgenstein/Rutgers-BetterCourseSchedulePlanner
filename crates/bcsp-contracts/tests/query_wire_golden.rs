use bcsp_contracts::{
    AvailabilityWindowV1, CampusCode, CatalogSubjectCode, CoreFilterV1, CourseQueryRequestV1,
    CourseQueryResponseV1, CourseSortFieldV1, CourseSortV1, CreditRangeV1, FilterRequestV1,
    FilterSearchTextV1, FilterSetModeV1, FilterTokenV1, FilterValuesInputV1, LiveOpenStateV1,
    MeetingLocationFilterV2, NormalizedFilterValuesV1, PageInfoV1, PageRequestV1,
    PermissionFilterV1, PrerequisiteFilterV1, QUERY_CONTRACT_VERSION, SectionIndex,
    SortDirectionV1, TermId, UserModalityV3, UserSynchronicityV3, WeekdayV1, filter_schema_v1,
};
use serde::Serialize;
...
#[test]
fn filter_schema_golden_locks_all_eighteen_v3_metadata_rows() {
