    ...
    <div className="course-app">
      ...
      <div className="course-app__container">
        <aside className="course-app__filters">
          <DataFetchCard
            defaultTerm={filters.term ?? dictionaryState.dictionary?.terms[0]?.value}
          ...
          <SubscriptionCenter
            term={filters.term ?? dictionaryState.dictionary?.terms[0]?.value}
            campus={filters.campus ?? dictionaryState.dictionary?.campuses[0]?.value}
          />
        </aside>
